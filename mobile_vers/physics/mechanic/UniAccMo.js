        ...
        Solve_4 = ' ';
            ...
            if (vk == 0) {
                if (a != 0 && t != 0) {
                    ...
                    Solve = `Так как у нас неизвестна только конечная скорость, то для нахождения перемещения мы можем воспользоваться формулой S = V₀•t + (a • t²)/2`;
        ...
        if (x != 0) {
            ...
            if (vk == 1) {
                ...
                if (t != 0) {
                    ...
                    Solve = `Воспользуемся формулой Vk = V0 + at`
                    Solve_1 = `Отсюда a = (${vk} - ${v0})/ ${t}`
                    Solve_2 = `Ответ: ${a} `
                    Solve_3 = ` `
                    Solve_4 = ` `
                }
